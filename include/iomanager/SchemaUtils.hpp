...
{
  if (l.system == r.system || l.system == "" || r.system == "") {
    if (l.data_type == r.data_type) {
      return l.uid < r.uid;
    }
    return l.data_type < r.data_type;
  }
  return l.system < r.system;
}
inline bool
operator==(ConnectionId const& l, ConnectionId const& r)
{
  return (l.system == "" || r.system == "" ||  l.system == r.system) && l.uid == r.uid &&
...
is_match(ConnectionId const& search, ConnectionId const& check)
{
  ...
  if (search.system != check.system && search.system != "" && check.system != "")
    return false;
...
{
  if (conn_id.system != "") {
    return conn_id.system + "/" + conn_id.uid + "@@" + conn_id.data_type;
  }
...
struct hash<dunedaq::iomanager::connection::ConnectionId>
{
  ...
  {
    return std::hash<std::string>()(conn_id.system + conn_id.uid + conn_id.data_type);
  }
};
